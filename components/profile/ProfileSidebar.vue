        ...
        <UCard class="mb-6">
            <div class="flex flex-col items-center">
                <div class="relative mb-4">
                    ...
                    <UButton
                        class=" absolute inset-0 flex items-center justify-center bg-gray-900/40 text-white rounded-full"
                    ...
                    <UModal v-model:open="isAvatarModalOpen" title="Profile picture"
